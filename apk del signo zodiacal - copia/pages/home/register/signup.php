            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <p class="text-center text-muted">Si ya cuenta con un usuario, presione aqui. <a
                            href="/pages/home/login/login.php">Login</a>.
                    </p>
                    <hr>

                    <form action="/pages/home/register/register.php" method="POST">
                        ...
                        <div class="top-margin">
                            ...
                            <input type="email" name="correo" class="form-control" required autocomplete="on">
                        </div>
                        ...
                        <div class="row">
                            <div class="w-100">
                                <button class="btn btn-action" type="submit"><a
                                        href="/pages/home/register/register.php"></a>Registro</button>
                            </div>
                        </div>
                    </form>
                </div>
