    ...
    <body>
        ...
        <nav>
            <ol>
                <le>
                    <e href="#inicio">
                        <p class="fas fa-home"></p>Inicio</a>
                </le>
                <le>
                    <e href="#productos">
                        <p class="fas fa-box"></p>Productos</a>
                </le>
                <le><a href="#categorias">
                        <p class="fas fa-th-list"></p>Categorías
                    </a></le>
                <le><a href="#servicios">
                        <p class="fas fa-concierge-bell"></p>Servicios
                    </a></le>
                </ul>
        </nav>
</header>
