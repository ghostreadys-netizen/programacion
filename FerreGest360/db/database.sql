...
VALUES (
    ...
    (
        ...
        '87654321-1-654321',
        'Ferretería Central',
        'Ferretería Central Ltda.',
        'Zona Libre de Colón',
        '507-456-7890',
        'ventas@ferreteriacentral.com',
        3000.00,
        45,
        8.00,
        1,
...
VALUES (
        ...
        882.75,
        'pendiente',
        'Pedido urgente de herramientas para proyecto',
        '2025-01-10 09:00:00'
    ),
    (
        2,
...
VALUES (1, 1, 1, 50, 0, 15.00, 750.00),
...
VALUES (
        ...
        '87654321-1-654321',
        'Zona Libre de Colón, Galera 12',
        '507-444-5555',
        'contacto@distribuidoracentral.com',
        'Luis Gómez',
        'Ejecutivo de Ventas',
        '507-6789-1234',
        'lgomez@distribuidoracentral.com',
        30,
        10.00,
        7,
        500.00,
        'Transferencia bancaria a 30 días',
        'https://www.distribuidoracentral.com',
...
ADD PRIMARY KEY (`id`),
ADD UNIQUE KEY `unique_empresa_factura` (
    `empresa_id`,
    `numero_factura`
),
